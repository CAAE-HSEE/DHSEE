...
class EncoderRegressionModel(chainer.Chain):
    ...
    def __init__(self, in_size=None, encoder_n_units=10, regression_n_units=10, common_out_size=10):
        ...
        with self.init_scope():
            ...
            self.regression24 = links.Linear(regression_n_units, 1, initialW=initial_w)
...
def main(encoder_n_units=32, common_size=16, regression_n_units=32, discriminator_n_units=32, batch_size_def=None,
         ...
         save_code=False, pre_best = [0, 0, 0, 0]):
...
if __name__ == '__main__':
    ...
    # -----------The struscute of the result{target1: {
